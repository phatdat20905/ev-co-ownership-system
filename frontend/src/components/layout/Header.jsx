  ...
  return (
    <header className="w-full fixed top-0 bg-white/90 backdrop-blur-md border-b border-gray-200 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Search + Notification + Auth Buttons */}
        <div className="flex items-center gap-3">
          ...
          {/* Notification icon (chuông) */}
          <div className="relative flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full hover:bg-gray-200 cursor-pointer transition">
            <Bell className="h-5 w-5 text-gray-600" />
            {/* Chấm đỏ báo có thông báo */}
