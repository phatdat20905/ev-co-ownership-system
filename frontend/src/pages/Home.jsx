...
import { Car, FileCheck, Users, Wallet, ArrowRight, CheckCircle, Clock, Shield, Zap, MapPin, Star, MessageCircle, Calendar, DollarSign, Battery, Settings, Play, TrendingUp, Award } from "lucide-react";
...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      content: "Từ khi tham gia EV Co-ownership, tôi tiết kiệm được hơn 70% chi phí di chuyển mà vẫn sử dụng xe điện đời mới.",
      rating: 5,
      avatar: "MN",
    ...
    },
    {
      ...
      content: "Hệ thống chia chi phí minh bạch và lịch trình công bằng giúp tôi hoàn toàn yên tâm khi đồng sở hữu.",
      rating: 5,
      avatar: "LP",
    ...
    },
    {
      ...
      content: "Ứng dụng rất dễ sử dụng, AI đề xuất lịch trình thông minh giúp mọi người đều có cơ hội sử dụng xe.",
      rating: 4,
      avatar: "TA",
      company: "Freelancer"
    }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-800 overflow-hidden">
      ...
      {/* ===== HERO SECTION ===== */}
      <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-20 pb-20 bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
        {/* Animated Background */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Quản lý đồng sở hữu xe điện một cách <span className="font-semibold text-blue-600">minh bạch, thông minh</span> và công bằng. 
              Cùng trải nghiệm di chuyển xanh, tiết kiệm và tiện lợi.
            </motion.p>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex items-center gap-4">
                ...
                >
                  <Play className={`w-4 h-4 text-white ${isPlaying ? 'hidden' : 'block'}`} />
                  <div className={`w-4 h-4 flex items-center justify-center ${!isPlaying ? 'hidden' : 'block'}`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Trải nghiệm <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">công nghệ</span> vượt trội
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Khám phá những tính năng độc đáo được thiết kế để mang lại sự tiện lợi và minh bạch tuyệt đối
            </p>
          </motion.div>
      ...
      <section id="process" className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Bắt đầu trong <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">4 bước</span>
            </h2>
          </motion.div>
              ...
              >
                <div className="relative mb-8">
                  <div className="w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center mx-auto mb-4 group-hover:shadow-xl transition-all duration-300">
                    <div className={`p-3 rounded-xl bg-gradient-to-r ${step.gradient} text-white shadow-md`}>
                      {step.icon}
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            ...
            >
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Hệ thống <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">EV Co-ownership</span>
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl">
                EV Co-ownership thúc đẩy mô hình <span className="font-semibold text-blue-600">chia sẻ xe điện</span>, giúp
      ...
      <section id="testimonials" className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Những <span className="bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent">câu chuyện</span> thành công
            </h2>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
              Tham gia cộng đồng đồng sở hữu xe điện thông minh ngay hôm nay và bắt đầu hành trình di chuyển xanh, tiết kiệm
            </p>
