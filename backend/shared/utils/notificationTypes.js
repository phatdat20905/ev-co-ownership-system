// backend/shared/utils/notificationTypes.js
...
export const NOTIFICATION_TEMPLATES = {
  ...
  [NOTIFICATION_TYPES.BOOKING_CANCELLED]: {
    ...
    body: 'Lịch đặt xe {{vehicleName}} vào {{startTime}} đã bị hủy. Lý do: {{reason}}',
    channels: ['in_app', 'push', 'email']
  },
  
  [NOTIFICATION_TYPES.BOOKING_REMINDER]: {
    title: 'Nhắc nhở lịch đặt xe',
    body: 'Lịch đặt xe {{vehicleName}} của bạn sẽ bắt đầu lúc {{startTime}}',
    channels: ['in_app', 'push']
  },
  
  [NOTIFICATION_TYPES.COST_ADDED]: {
    title: 'Chi phí mới được thêm',
    body: 'Chi phí {{category}} trị giá {{amount}} đã được thêm vào nhóm {{groupName}}',
    channels: ['in_app', 'push']
  },
  ...
  [NOTIFICATION_TYPES.PAYMENT_REMINDER]: {
    ...
    body: 'Bạn có khoản thanh toán {{amount}} sắp đến hạn vào {{dueDate}}',
    channels: ['in_app', 'push', 'email']
  },
  
  [NOTIFICATION_TYPES.CONTRACT_SIGNED]: {
    title: 'Hợp đồng đã được ký',
    body: 'Hợp đồng {{title}} đã được ký thành công',
    channels: ['in_app', 'push', 'email']
  },
  
  [NOTIFICATION_TYPES.CONTRACT_APPROVED]: {
    title: 'Hợp đồng được duyệt',
    body: 'Hợp đồng {{title}} đã được {{approvedBy}} phê duyệt',
    channels: ['in_app', 'push', 'email']
  },
  ...
  [NOTIFICATION_TYPES.AI_FAIRNESS_ANALYSIS]: {
    ...
    body: 'AI đã hoàn thành phân tích công bằng cho nhóm {{groupName}}. Mức độ công bằng: {{fairnessLevel}} ({{overallScore}}/100)',
    channels: ['in_app', 'push']
  },
  ...
  [NOTIFICATION_TYPES.DISPUTE_RESOLVED]: {
    ...
    body: 'Tranh chấp của bạn đã được giải quyết. Kết quả: {{resolution}}',
    channels: ['in_app', 'push', 'email']
  },
  ...
  [NOTIFICATION_TYPES.GROUP_MEMBER_ADDED]: {
